...
const abi = require('./SmartContractAbi.json'); // Ensure this file is generated during compilation
const bytecode = fs.readFileSync(path.join(__dirname, 'SmartContractBytecode.bin'), 'utf8'); // Ensure this file is generated during compilation
...
const deploy = async () => {
    try {
        ...
        fs.writeFileSync('SmartContractAddress.txt', contract.options.address);
        console.log('Contract address saved to SmartContractAddress.txt');
    } catch (error) {
